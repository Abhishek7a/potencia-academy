...
export default function AboutUs() {
    return (
        <section className='mx-lg-3 rounded mt-lg-1 mb-5 m-md-5 about'>
            <div className=''>
