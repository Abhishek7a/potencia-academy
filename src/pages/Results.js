    ...
    <>
      ...
      <h1 className='text-center'>{props.heading}</h1>
        ...
        <div className="text-center position-relative card col-md-3 mt-sm-5">
          <img className="card-img-top w-50 rounded-circle mt-5 mx-auto p-2 " style={{ border: "2px solid #212844", maxHeight: "170px" }} src={anmol} alt="Card image cap" />
        ...
        <div className="text-center card col-md-3  mt-3 mt-sm-5">
          <img className="card-img-top w-50 rounded-circle mt-5 mx-auto p-2" style={{ border: "2px solid #212844", maxHeight: "170px" }} src={prince} alt="Card image cap" />
          <div className="card-body my-3">
            <h4>Prince</h4>
          </div>
        ...
        <div className="text-center card col-md-3 mt-sm-5 mt-3">
          <img className="card-img-top w-50 rounded-circle mt-5 mx-auto p-2" style={{ border: "2px solid #212844", maxHeight: "170px" }} src={kushdeep} alt="Card image cap" />
          <div className="card-body my-3">
            <h4>Kushdeep</h4>
          </div>
          <span className="badge position-absolute p-2 top-0 fs-6 " style={{ backgroundColor: "#212844", right: "0" }}>2023</span>
