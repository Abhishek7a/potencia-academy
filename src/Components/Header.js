                        ...
                        <ul className="navbar-nav ms-auto mb-2 mb-lg-0 mx-2 fw-bold ">
                            ...
                            <li className="nav-item dropdown mx-lg-2" >
                                ...
                                <ul className="dropdown-menu ">
                                    ...
                                    <Link onClick={goToTop}  className={`${location.pathname === "/courses" ? "link  " : "nav-link"}`} style={{ color: "#212844" }} to="/courses"> <li data-bs-toggle="collapse" data-bs-target=".navbar-collapse.show">Courses Find </li></Link>
                                    <Link onClick={goToTop}  className={`${location.pathname === "/answerKey" ? "link " : "nav-link"}`} style={{ color: "#212844" }} to="/answerKey"> <li data-bs-toggle="collapse" data-bs-target=".navbar-collapse.show">Answer Key </li></Link>
                                </ul>
                            </li>
