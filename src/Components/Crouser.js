            ...
            <div id="carouselExampleControls" className="carousel slide my-lg-1  mx-lg-3" data-bs-ride="carousel">
                <div className="carousel-inner rounded-3">
                    <div className="carousel-item active h-md-100 ">
                        ...
                        {/* <img src="https://www.potencia.in/wp-content/uploads/2023/01/Testing-4-9.webp" className="d-block w-100 crouser_img" alt="..." /> */}
                    </div>
                    <div className="carousel-item rounded-3">
                        ...
                        {/* <img src="https://www.potencia.in/wp-content/uploads/2023/01/Slide-Number-2.webp" className="d-block w-100 crouser_img " alt="..." /> */}
                    </div>
                </div>
                <p className='text-center my-3 fw-bold heading ' style={{ color: "#212844" }}>POTENCIA ACADEMY - <span>UNLEASH YOUR POTENTIAL</span></p>
