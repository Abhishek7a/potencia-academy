        ...
        <section className='mx-lg-3 rounded-md m-lg-5 m-md-5 about'>
            <div className='d-lg-flex  text-center  d-sm-block '>
                ...
                <div className='flex  p-lg-5 p-md-3 p-2 '>
                    ...
                    <p className='mt-5 mx-lg-5 text-start fs-6  px-lg-5 px-md-1 mx-md-0 mx-sm-0 text-wrap text' style={{color:"#ced9eb"}}>POTENCIA ACADEMY provides interactive lectures from qualified faculties to guide the students for their success in engineering and medical entrances and board examinations. Lays foundation from class IX for better future in any field. Also provides Aptitude classes for different competitive exams. All faculties are from IITs with good experience and the best knowledge in their respective subjects, who will lead you towards sucess by clearing basic concept without cramming them. Aptitude classes for different competitive exams. </p>
                </div>
            </div>
